Shader "Custom/Advanced Lit/Phong Multiple Light and Shadow"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float3 CalculateLighting(half3 baseColor, Light light, float3 normal, float3 viewDir)
            {
                ...
                float3 specColor = spec * _SpecColor.rgb * light.color.rgb * _SpecularIntensity * light.shadowAttenuation;
